    ...
    <div style={{ minHeight: '100vh', background: '#FFFFFF', color: '#1E293B', fontFamily: '"Sora", -apple-system, BlinkMacSystemFont, sans-serif', overflowX: 'hidden' }}>
      ...
      <nav style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '18px 52px', borderBottom: '1px solid #F0FDF4', position: 'sticky', top: 0, background: '#FFFFFF', zIndex: 50 }}>
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
          ...
          <Link href="/signup" className="cta" style={{ padding: '8px 20px', background: '#059669', color: '#fff', borderRadius: 8, fontWeight: 700, textDecoration: 'none', fontSize: 13 }}>
            Sign up →
          </Link>
        </div>
      </nav>
      ...
      <div style={{ textAlign: 'center', padding: '80px 48px 100px', background: '#FFFFFF' }}>
        ...
        <Link href="/signup" className="cta" style={{ display: 'inline-flex', alignItems: 'center', gap: 10, padding: '14px 36px', background: '#059669', color: '#fff', borderRadius: 10, fontWeight: 700, textDecoration: 'none', fontSize: 16 }}>
          Get Started →
        </Link>
      </div>
