...
export const MEGA_CATEGORIES: Record<MegaCategory, MegaCategoryInfo> = {
  ...
  food:                 { key:'food',                 label:'Food & Dining',            icon:'', color:'var(--danger-t)', bgColor:'var(--danger-f)', borderColor:'var(--danger-b)', routesTo:'expense' },
  shopping:             { key:'shopping',             label:'Shopping',                 icon:'', color:'#8A6A1A', bgColor:'#FBF6EE', borderColor:'#EDD898', routesTo:'expense' },
  investments_elss:     { key:'investments_elss',     label:'Tax-saving SIP (ELSS) → 80C', icon:'', color:'#2A7A4A', bgColor:'#EEF2EE', borderColor:'#C8D8C8', routesTo:'tax_save' },
  ...
  transport:            { key:'transport',            label:'Transport & Fuel',         icon:'', color:'var(--danger-t)', bgColor:'var(--danger-f)', borderColor:'var(--danger-b)', routesTo:'expense' },
  ...
  utilities:            { key:'utilities',            label:'Utilities & Recharges',    icon:'', color:'var(--danger-t)', bgColor:'var(--danger-f)', borderColor:'var(--danger-b)', routesTo:'expense' },
  healthcare:           { key:'healthcare',           label:'Healthcare & Pharmacy',    icon:'', color:'var(--danger-t)', bgColor:'var(--danger-f)', borderColor:'var(--danger-b)', routesTo:'expense' },
  housing:              { key:'housing',              label:'Housing (Rent / EMI)',     icon:'', color:'var(--danger-t)', bgColor:'var(--danger-f)', borderColor:'var(--danger-b)', routesTo:'expense' },
  insurance:            { key:'insurance',            label:'Insurance',                icon:'', color:'var(--danger-t)', bgColor:'var(--danger-f)', borderColor:'var(--danger-b)', routesTo:'expense' },
...
const KNOWN_MERCHANT_WORDS = [
  ...
  'URBAN COMPANY','URBAN CLAP','URBANCLAP','1MG','TATA 1MG','LENSKART','DECATHLON',
  'CULT FIT','CULT.FIT','CUREFIT','DUNZO','D MART','DMART','PEPPERFRY','IKEA',
  'STAR HEALTH','NIVA BUPA','HDFC ERGO','ACKO','GO DIGIT',
  'FERNS N PETALS','LICIOUS','FRESHTOHOME','COUNTRY DELIGHT',
]
