...
export const MEGA_CATEGORIES: Record<MegaCategory, MegaCategoryInfo> = {
  ...
  food:                 { key:'food',                 label:'Food & Dining',            icon:'', color:'#B94040', bgColor:'#FBF0F0', borderColor:'#F0CECE', routesTo:'expense' },
  ...
  insurance:            { key:'insurance',            label:'Insurance',                icon:'', color:'#B94040', bgColor:'#FBF0F0', borderColor:'#F0CECE', routesTo:'expense' },
